...
public class Main {
    ...
    private static void initializeAssets(final AssetManager theAssetManager) {
        ...
        theAssetManager.loadAsset("warriorImage", "src/resources/assets/player/Edgar.png");
        theAssetManager.loadAsset("thiefImage", "src/resources/assets/player/Locke.png");
        theAssetManager.loadAsset("priestessImage", "src/resources/assets/player/Celes.png");
        theAssetManager.loadAsset("berserkerImage", "src/resources/assets/player/Setzer.png");
        theAssetManager.loadAsset("mageImage", "src/resources/assets/player/Terra.png");
        ...
        theAssetManager.loadAsset("infiniteDamageImage", "src/resources/assets/Buttons/.png");
